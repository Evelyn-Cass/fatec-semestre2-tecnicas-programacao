...
class ProdutoDAO extends Conexao
{
	...
	public function buscar_todos_ativos()
	{
		$sql = "SELECT p.*, c.descritivo 
				FROM produtos as p, categorias as c 
				WHERE p.id_categoria = c.id_categoria AND situacao = ?";
		try {
			$stm = $this->db->prepare($sql);
	...
	public function buscar_produtos_por_categoria(Produto $produto)
	{
	...
	public function mudar_situacao(Produto $produto)
	{
		$sql = "UPDATE produtos 
					SET situacao = ? 
					WHERE id_produto = ?";
