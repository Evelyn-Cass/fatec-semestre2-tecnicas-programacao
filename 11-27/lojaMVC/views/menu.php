	...
	<div class="container" id="container">
		...
		<div id="produtos" class="d-flex justify-content-around align-items-center">
			...
			foreach ($produtos as $produto) {
				...
				<div class='card-body'>
				<h6 class='card-title'  style='overflow:hidden;white-space: nowrap;max-width:18rem;height:20px;text-overflow:ellipsis;'>{$produto->nome}</h6> 
				<h6 class='card-title'  style='text-overflow:ellipsis;'> R$ $preco</h6>
